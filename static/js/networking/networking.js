...
class Room1 {
    ...
    getCurrentLevelName() {
        const levelNames = ['Basics', 'Decisions', 'Processes', 'Complex Flow', 'Master'];
        return levelNames[Math.min(this.currentLevel - 1, levelNames.length - 1)];
    }

    getCurrentInstruction() {
        return this.currentLevelData ? this.currentLevelData.instruction : 'Select "Start Learning" to begin';
    }

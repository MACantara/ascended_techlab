export class TerminalManager {
            ...
            <div class="assessment-step">
                ...
                <div class="sql-terminal bg-black p-4 rounded mb-4">
                    <div class="terminal-header bg-gray-800 p-2 rounded-t flex justify-between items-center">
                        <span class="text-green-400">SQLite Terminal</span>
                        <span class="text-gray-400">Server version: 3.x</span>
                    </div>
                    <div id="terminal-container" class="terminal-body p-4" style="min-height: 300px; max-height: 400px; overflow-y: auto;">
                        <div id="terminal-output" class="font-mono text-sm text-gray-300 mb-3">
                            <div class="text-blue-400">SQLite [CriticalBusiness_DB]> </div>
                            <div class="text-gray-400 mb-2">Welcome to the SQLite terminal. Commands end with ; or \\g.</div>
                        ...
                        <div class="terminal-input flex items-center">
                            <span class="text-blue-400 mr-2">sqlite> </span>
                ...
                <div class="diagnostic-hint bg-blue-900 p-3 rounded">
                    <p class="text-blue-200 text-sm">
                        ...
                        <code>PRAGMA table_info(tablename);</code> |
                        <code>.quit</code>
                    </p>
                </div>
            </div>
            ...
            <div class="repair-step">
                ...
                <div class="repair-terminal bg-black p-4 rounded mb-4">
                    <div class="terminal-header bg-gray-800 p-2 rounded-t">
                        <span class="text-yellow-400">Repair Terminal - SQLite Recovery Mode</span>
                    </div>
                    <div class="repair-console p-4" style="min-height: 200px; max-height: 300px; overflow-y: auto;">
                        <div id="repair-output" class="font-mono text-sm text-gray-300 mb-3">
                            <div class="text-blue-400">sqlite> </div>
                            <div class="text-gray-400 mb-2">Ready for table repair operations.</div>
                            <div class="text-gray-400 mb-4">Use: VACUUM; PRAGMA integrity_check; REINDEX;</div>
                        </div>
    ...
    executeSQLCommand() {
        ...
        commandDiv.innerHTML = `<span class="text-blue-400">sqlite> </span><span class="text-white">${command}</span>`;
        terminalOutput.appendChild(commandDiv);

        // Process command and generate result
        const result = this.room.sqlProcessor.processSQL(command.toUpperCase());
    ...
    executeRepairCommand() {
        ...
        const result = this.room.sqlProcessor.processSQL(command);

...
class Room2 {
    ...
    startGame() {
        ...
        this.gameTimer = setInterval(() => {
            this.gameTime++;
            this.trafficManager.updateTraffic();
            this.nodeManager.updateNodeLoads();
            this.updateUptime();
            this.trafficManager.updateTrafficVisualization();
        ...
        this.visualTimer = setInterval(() => {
            this.trafficManager.updateTrafficParticles();
        }, 50);
    }
